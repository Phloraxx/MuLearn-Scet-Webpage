...
pass(appSource.includes('document.fonts?.ready'), 'Loader can reveal the page before route fonts are ready')
...
for (const file of ['site.webmanifest', 'favicon.ico', 'assets/favicon-64.png', 'assets/apple-touch-icon.png', 'assets/og/home.webp', 'assets/og/orientation-2026.webp', 'assets/og/team.webp', 'assets/og/karma-war.webp', 'assets/karmawar/previews/karma-album-v4.webp', 'assets/karmawar/previews/karma-highlights-v3.webp', 'assets/karmawar/previews/karma-winners-v3.webp', 'loader-preflight-v4.js']) pass(await exists(resolve(root, 'public', file)), `Missing public asset: ${file}`)
